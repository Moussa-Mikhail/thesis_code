...
static PyMethodDef __pyx_mdef_12transform_cy_1transform_to_corotating = {"transform_to_corotating", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_12transform_cy_1transform_to_corotating, METH_VARARGS|METH_KEYWORDS, 0};
